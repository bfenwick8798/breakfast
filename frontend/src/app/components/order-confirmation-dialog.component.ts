...
@Component({
  ...
  template: `
    <div class="confirmation-dialog">
      <h2 mat-dialog-title>{{ translationService.t.isThisCorrect }}</h2>
      
      <mat-dialog-content class="order-summary">
        <!-- Customer Info -->
        <div class="section">
          <h3>{{ translationService.t.customerInformation }}</h3>
        ...
        <!-- Date & Time -->
        <div class="section">
          <h3>{{ translationService.t.confirmationDateTimeHeader }}</h3>
        ...
        <div class="section" *ngIf="hasSelectedItems()">
          <h3>{{ translationService.t.orderItems }}</h3>
        ...
        <div class="section" *ngIf="!hasSelectedItems()">
          <p class="no-items">{{ translationService.t.messages.noFoodItemsSelected }}</p>
        </div>
      </mat-dialog-content>

      <mat-dialog-actions align="end">
        <button mat-raised-button (click)="onCancel()" style="width: 45%">
        ...
        <button 
          ...
          [disabled]="!canSubmit"
          style="width: 45%">
          <span *ngIf="!canSubmit">{{ translationService.t.messages.yesSubmit }} ({{ countdown }})</span>
          <span *ngIf="canSubmit">{{ translationService.t.messages.yesSubmit }}</span>
        </button>
      </mat-dialog-actions>
    </div>
  `,
  styles: [`
    ...
    mat-dialog-actions button:disabled .mat-button-wrapper {
      color: #9e9e9e !important;
    }
  `],
  imports: [MatButtonModule, MatDialogModule, CommonModule]
})
export class OrderConfirmationDialogComponent implements OnDestroy {

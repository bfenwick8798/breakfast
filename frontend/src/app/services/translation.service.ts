...
export interface Translations {
  ...
  // Informational
  orderItems: string;
  noFoodItemsSelected: string;
  isThisCorrect: string;
  customerInformation: string;
  confirmationDateTimeHeader: string;
  // Special Options
...
export class TranslationService {
  ...
  private translations: Record<Language, Translations> = {
    en: {
      ...
      noFoodItemsSelected: 'Nothing is selected.',
      isThisCorrect: 'Is this correct?',
      customerInformation: 'Customer Information',
      confirmationDateTimeHeader: 'Date & Time',
      // Messages
      messages: {
    ...
    fr: {
      ...
      noFoodItemsSelected: 'Rien n\'est sélectionné.',
      isThisCorrect: 'Est-ce correct?',
      customerInformation: 'Informations Client',
      confirmationDateTimeHeader: 'Date et Heure',
      // Messages
      messages: {
